...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TGLPoiTex1D<_TItem_:record;_TImager_:TGLPoiIma1D<_TItem_>,constructor> = class( TGLTextur<_TItem_,TPoinArray1D<_TItem_>,TGLPoiPix1D<_TItem_>,_TImager_> )
     private
     protected
     public
       constructor Create;
     ...
     TGLCelTex1D<_TItem_:record;_TImager_:TGLCelIma1D<_TItem_>,constructor> = class( TGLTextur<_TItem_,TCellArray1D<_TItem_>,TGLCelPix1D<_TItem_>,_TImager_> )
     private
     protected
     public
       constructor Create;
